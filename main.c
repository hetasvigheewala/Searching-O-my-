...
void sortCountriesByGDPperCap(Country data[], int size){
   ...
   for (int i = 1; i < size; ++i) {
       Country key = data[i];
       int j = i - 1;
       while (j >= 0 && (data[j].gdp / data[j].pop) < (key.gdp / key.pop)) {
           data[j + 1] = data[j];
           j = j - 1;
       }
       data[j + 1] = key;
...
void sortCountriesByGHGperCap(Country data[], int size){
    ...
    for (int i = 1; i < size; ++i) {
       Country key = data[i];
       int j = i - 1;
       while (j >= 0 && ((data[j].ghg / data[j].pop) < (key.ghg / key.pop))) {
           data[j + 1] = data[j];
           j = j - 1;
       }
       data[j + 1] = key;
...
void sortCountriesByRE(Country data[], int size){
    ...
    for (int i = 1; i < size; ++i) {
       Country key = data[i];
       int j = i - 1;
       while (j >= 0 && data[j].renewable < key.renewable) {
           data[j + 1] = data[j];
           j = j - 1;
       }
       data[j + 1] = key;
...
void sortCountriesByREperCap(Country data[], int size){
  ...
  for (int i = 1; i < size; ++i) {
       Country key = data[i];
       int j = i - 1;
       while (j >= 0 && ((data[j].renewable / data[j].pop) < (key.renewable / key.pop))) {
           data[j + 1] = data[j];
           j = j - 1;
       }
       data[j + 1] = key;
...
void sortCountriesByCode(Country data[], int size){
    ...
    for (int i = 1; i < size; ++i) {
        Country key = data[i];
        int j = i - 1;
        while (j >= 0 && strcmp(data[j].code, key.code) > 0) {
            data[j + 1] = data[j];
            j = j - 1;
        }
        data[j + 1] = key;
